...
case $2 in
1)
	echo " " > /tmp/upload/clash_log.txt
	http_response "$1"
	echo_date "===================================================================" >> /tmp/upload/clash_log.txt
	echo_date "                GeoIP程序更新" >> /tmp/upload/clash_log.txt
	echo_date "===================================================================" >> /tmp/upload/clash_log.txt
	get_latest_version >> /tmp/upload/clash_log.txt 2>&1
	echo_date "===================================================================" >> /tmp/upload/clash_log.txt
	echo "DONE" >> /tmp/upload/clash_log.txt
	;;
esac