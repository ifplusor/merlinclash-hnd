...
function openmcHint(itemNum) {
	...
	if (itemNum == 13) {
		width = "350px";
		bgcolor = "#CC0066",
		statusmenu += "<span><b><font color='#CC0066'>自定义延迟检查</font></b></br>"
		statusmenu += "&nbsp;&nbsp;&nbsp;&nbsp;--------------------功能背景--------------------</br>"
		statusmenu += "&nbsp;&nbsp;&nbsp;&nbsp;clash启动后需检查开启状态，部分设备(68U等)，</br>"
		statusmenu += "&nbsp;&nbsp;&nbsp;&nbsp;因性能问题启动较慢，导致clash启动失败。</br>"
		statusmenu += "&nbsp;&nbsp;&nbsp;&nbsp;--------------------解决问题--------------------</br>"
	...
	if (itemNum == 16) {
		...
		statusmenu += "&nbsp;&nbsp;&nbsp;&nbsp;Merlinclash_分区域自动测速</br>"
		statusmenu += "&nbsp;&nbsp;&nbsp;&nbsp;Merlinclash_媒体与分区域自动测速</br>"
		_caption = "延迟容差值说明";
